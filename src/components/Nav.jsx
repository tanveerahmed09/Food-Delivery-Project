...
<div className="w-full h-[100px] flex justify-between items-start px-4 md:px-8 pt-4 overflow-x-hidden">
     ...
     <form className='w-[45%] h-[60px] bg-white flex items-center px-5 gap-5
       ...
       <div className='w-[60px] h-[60px] bg-white flex justify-center items-center
        rounded-md shadow-xl relative cursor-pointer'  onClick={()=>{
          ...
          <span className='absolute top-0 right-3 text-green-500 font-bold text-[15px]'>
            {items.length}</span>
